...
<head>
    ...
    <script type="text/javascript">
        if("ontouchend" in document) document.write("<script src='/js/assets/js/jquery.mobile.custom.min.js'>"+"<"+"script>");
    </script>
    <script src="/js/assets/js/bootstrap.min.js"></script>
    <script src="/js/assets/js/typeahead-bs2.min.js"></script>
    <!--[if lte IE 8]>
    <script src="/js/assets/js/excanvas.min.js"></script>
    <![endif]-->
    <script src="/js/assets/js/ace-elements.min.js"></script>
    <script src="/js/assets/js/ace.min.js"></script>
    <script src="/js/assets/layer/layer.js" type="text/javascript"></script>
    <script src="/js/assets/layDate/layDate.js" type="text/javascript"></script>
    ...
    <div class="navbar-container" id="navbar-container">
        <div class="navbar-header pull-left">
            <a href="#" class="navbar-brand">
                <small>
                    <div style="font-size: 30px;font-family:宋体;margin-top: 20px;color:#BEE9F0">供应链系统</div>
                </small>
            </a><!-- /.brand -->
        </div><!-- /.navbar-header -->
...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div id="menu_style" class="menu_style">
                <ul class="nav nav-list" id="nav_list">
                    <li class="home"><a href="javascript:void(0)" name="/jsp/welcome.jsp" class="iframeurl" title=""><i class="icon-home"></i><span class="menu-text"> 系统首页 </span></a></li>
                    <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 样板管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a  href="javascript:void(0)" name="/jsp/test.jsp"  title="产品类表" class="iframeurl"><i class="icon-double-angle-right"></i>产品类表</a></li>
                    ...
                    <li>
                        <a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 采购管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                    ...
                    <li>
                        <a href="#" class="dropdown-toggle"><i class="icon-credit-card"></i><span class="menu-text"> 流水线管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                    ...
                    <li>
                        <a href="#" class="dropdown-toggle"><i class="icon-user"></i><span class="menu-text"> 仓库管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                    ...
                    <li><a href="#" class="dropdown-toggle"><i class="icon-laptop"></i><span class="menu-text"> 财务管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                    ...
                    <li><a href="#" class="dropdown-toggle"><i class="icon-comments-alt"></i><span class="menu-text"> 生产管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                    ...
                    <li><a href="#" class="dropdown-toggle"><i class="icon-bookmark"></i><span class="menu-text"> 基础数据 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                    ...
                    <li><a href="#" class="dropdown-toggle"><i class="icon-cogs"></i><span class="menu-text"> 系统设置 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
        ...
        <div class="main-content">
            ...
            <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="/jsp/welcome.jsp">  </iframe>
